...
public class Main {
  ...
  public static void main(String[] args) 
  {
    ...
    get("/hello", (req, res) -> 
    {
    	...
    	try 
    	{
    		URL url = new URL("https://offersvc.expedia.com/offers/v2/getOffers?scenario=deal-finder&page=foo&uid=foo&productType=Hotel&lengthOfStay=3");
  ...
  {
//	  sb.append("Offer Info : <br/>Site ID : " + bigOffer.getOfferInfo().getSiteID() + "<br/>Language : " + bigOffer.getOfferInfo().getLanguage() + "<br/>Currency : " + bigOffer.getOfferInfo().getCurrency() + "<br/>");
//	  sb.append("<br/>");
//	  sb.append("User Info : <br/>persona : " + bigOffer.getUserInfo().getPersona().getPersonaType() + "<br/>User ID : " + bigOffer.getUserInfo().getUserId() + "<br/>");
//	  sb.append("<br/><hr><hr>");
